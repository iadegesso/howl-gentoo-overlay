...
src_install() {
	...
	insinto /etc/conf.d/
	doins ${FILESDIR}/cdemu-daemon

	insinto /usr/lib/modules-load.d/
	doins ${FILESDIR}/vhba.conf

	exeinto /usr/lib/cdemu-daemon/
	doexe ${FILESDIR}/cdemu-daemon-system.sh
	doexe ${FILESDIR}/cdemu-daemon-session.sh

	systemd_dounit ${FILESDIR}/cdemu-daemon.service
}
